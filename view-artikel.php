...
$sql = <<<SQL
  SELECT a.judul_artikel, a.image, a.isi_artikel ,a.tanggal_dibuat, a.waktu_dibuat, a.pic, k.nama_kategori 
        ...
        <section class="section" id="hasil-pencarian">
          <div class="section-header">
            <div class="section-header-back">
              <a href="all-post.php" class="btn btn-icon"><i class="fas fa-arrow-left"></i></a>
            </div>
            <h1>Article</h1>
          ...
          <h2 class="section-title">View Article</h2>
              <div class="row">
                    ...
                    <div class="d-flex align-items-center my-3 justify-content-between">
                        <section class="d-flex align-items-center">
                            <div class="image_author">
                                <img src="assets/img/avatar/avatar-1.png" width="50" class="rounded-circle mr-2" alt="annie">
                            </div>
                            <div class="post">
